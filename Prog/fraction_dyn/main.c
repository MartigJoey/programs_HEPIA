...
double formula_1() {
    ...
    sum->num = 1;
    sum->den = 1;
    fraction *current = malloc(sizeof(fraction));
    double computed_pi;
    int i;
    for (i = 2; i < 100; i++) {
        current->num = 1;
...
double formula_3() {
    ...
    sum->den = 1;
    fraction *current = malloc(sizeof(fraction));
    fraction *current_1 = malloc(sizeof(fraction));
    fraction *current_2 = malloc(sizeof(fraction));
    double computed_pi;
    int i;
    for (i = 1; i < 100; i++) {
        current_1->num = 2 * i;
...
int main() {
    fraction *frac_test = malloc(sizeof(fraction));
    frac_test->num = 10;
    frac_test->den = 2;
    ...
    fraction *frac_pow = malloc(sizeof(fraction));
    *frac_pow = *fraction_pow(frac_test, 2);
    printf("pow 2 irreductible = %lld / %lld\n", frac_pow->num, frac_pow->den);

    fraction *frac_result = malloc(sizeof(fraction));
    fraction *frac_1 = malloc(sizeof(fraction));
    frac_1->num = 1;
    frac_1->den = 3;
    fraction *frac_2 = malloc(sizeof(fraction));
    frac_2->num = 3;
    frac_2->den = 6;
